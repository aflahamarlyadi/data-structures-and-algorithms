...
This module contains an implementation of an Circular Queue data structure.
...
class CircularQueue(QueueADT[T]):
    ...
    def __init__(self, max_capacity: int) -> None:
        """
        Initialises an empty circular queue with the given maximum capacity.
    ...
    def __str__(self) -> str:
        ...
        for _ in range(len(self)):
            items.append(str(self.array[index]))
